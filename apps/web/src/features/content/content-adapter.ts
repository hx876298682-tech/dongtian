...
const ID_LABELS: Readonly<Record<string, string>> = {
  ...
  'action.t1.combat_qingshe': '青蛇战斗',
  'action.t1.combat_qingshe_wang': '青蛇王战斗',
  'action.t1.combat_zhuling_yao': '竹灵妖战斗',
  'action.t1.combat_gray_wolf': '灰狼战斗',
  'action.t1.combat_shijia_beast': '石甲兽战斗',
  'action.t1.combat_chitong_jiachong': '赤铜甲虫战斗',
  'action.t1.combat_wuying_yuan': '无影猿战斗',
  'action.t1.combat_xingwen_kui': '星纹傀战斗',
  'action.t1.combat_heifeng_lang': '黑风狼战斗',
  'action.t1.combat_lingquan_shouwei': '灵泉守卫战斗',
  'action.t1.combat_heifeng_yaowang': '黑风妖王战斗',
