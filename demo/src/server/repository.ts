...
export const makeInitialPlayer = (playerId: string, now: Date, configVersion = CONFIG_VERSION): PlayerState => ({
  ...
  resources: {
    ...
    pill_zi_yun_normal: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_zi_yun_fine: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_zi_yun_rare: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_zi_yun_epic: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_ning_lu_normal: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_ning_lu_fine: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_ning_lu_rare: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_ning_lu_epic: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_huang_long_normal: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_huang_long_fine: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_huang_long_epic: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_chi_yan_normal: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_chi_yan_fine: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
    pill_chi_yan_epic: { amount: 0, capacity: 500, reservedAmount: 0, overflowAmount: 0 },
